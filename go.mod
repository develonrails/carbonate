...
require (
	github.com/ProtonMail/go-proton-api v0.0.0-20260910134021-f5018daf7888
...
// go-proton-api depends on Proton's fork of resty. A replace directive in a
// dependency is ignored by Go, so it has to be repeated here or the build
// fails on missing multipart-stream APIs.
