...
func TestCompatPassesResponsesThrough(t *testing.T) {
	...
	compat(inner).ServeHTTP(rec, httptest.NewRequest(http.MethodPut, "/x", nil))
...
func TestCompatDefaultsToOK(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	compat(inner).ServeHTTP(rec, httptest.NewRequest(http.MethodGet, "/x", nil))
...
func TestCompatRewritesXMLBody(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	compat(inner).ServeHTTP(rec, httptest.NewRequest("PROPFIND", "/x", nil))
...
func TestCompatLeavesNonXMLAlone(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	compat(inner).ServeHTTP(rec, httptest.NewRequest(http.MethodGet, "/x.ics", nil))
...
func TestCompatAddsPutToOptions(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	compat(inner).ServeHTTP(rec, httptest.NewRequest(http.MethodOptions, "/x/", nil))
